...
1.1. exp1.pl [data_dir] [datatype_1] .. [datatype_n]
  ...
  Example:
  > perl exp1.pl ~/Development/6DMG/data_htk/gestures NPNVNOs2
...
1.2. exp1_err_rep.pl [data_dir] [datatype_1] .. [datatype_n]
  ...
  Example:
  > perl exp1_err_rep.pl ~/Development/6DMG/data_htk/gestures NPNVNOs2
  Example output:
...
2.3. exp2_err_rep.pl [data_dir] [datatype_1] .. [datatype_n]
  ...
  Example:
  > perl exp2_err_rep.pl ~/Development/6DMG/data_htk/gestures NPNVNOs2
  Example output:
...
3.3. exp3_err_rep.pl [data_dir] [datatype_1] .. [datatype_n]
  ...
  Example:
  > perl exp3_err_rep.pl ~/Development/6DMG/data_htk/gestures NPNVNOs2
  Example output:
