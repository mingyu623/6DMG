...
# output
my $tstSCP    = "$path/gt_test.scp";
my $tstOovSCP = "$path/gt_testOOV.scp";
my $detMLF    = "$path/gt_ref.mlf";


#=======================================================
# 1. Create gt_test.scp & gt_testOOV.scp
#=======================================================
...
#=======================================================
# Generate gt_ref.mlf for HResults
#=======================================================
