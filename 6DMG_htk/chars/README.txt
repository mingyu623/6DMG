...
0.1. 0_gen_share.pl
  This script generates the HTK essential files for character recognition.
  These files are shared by all data types.
  Example:
  > perl 0_gen_share.pl
  Output:
   - share/gestDic
...
0.2. 0_gen_single_proto.pl [datatype] [# states]
  This script generates one proto file for HTK with specified data type and states number.
  [Note] the user needs the proto templates for state numbers of 10, 12, 14, 16, 18 to
