#!/usr/bin/perl
# Mingyu @ Apr 21 2013
# 1. Generate the wdnet and dict for the motion word recognition task
#    (100-word vocab + 1k-word vocab)
#    Enforce the "fil" model at the begin and end of each word (in the dict!)
# 2. Copy the word level mlf (word.mlf) from data_htk/airwriting_spot/train/mlf
#    (from filtered detected results)
...
# word.mlf is copied from ../../../data_htk/airwriting_spot/train/mlf
#-------------------------------------------------------------------------
my $srcMlf = "../../../data_htk/airwriting_spot/train/mlf/word.mlf";
unless (-e $srcMlf) {
