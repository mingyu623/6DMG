...
# the vocab of ground-truth words = 1k

use strict;
use File::stat;
my $data_dir = "data_NP2DuvNV2D";

# Create the word level mlf for all 1k words
open (FILE, '>mlf/word.mlf') or die $!;
print FILE "\#!MLF!\#\n";

# Create the char level mlf for all 1k words
open (WORD_L, ">mlf/word_char.mlf") or die $!;
print WORD_L "\#!MLF!\#\n";

# Create the char level + multi ligs for all 1k words
...
print "Total $cnt word segments (filtered)\n";
