...
bool Database::Open(int flag) {
  ...
  if (rc) {
    ...
    */
    ...
    rc = sqlite3_prepare_v2(db, loadOneGestureSQL.c_str(),
                            loadOneGestureSQL.size() + 1, &loadOneGestureStmt, 0);
    ...
    rc = sqlite3_prepare_v2(db, getCurrentTrialSQL.c_str(),
                            getCurrentTrialSQL.size() + 1, &getCurrentTrialStmt, 0);
    ...
    rc = sqlite3_prepare_v2(db, deleteOneGestureSQL.c_str(),
                            deleteOneGestureSQL.size() + 1, &deleteOneGestureStmt, 0);
    ...
    rc = sqlite3_prepare_v2(db, loadTestersSQL.c_str(),
                            loadTestersSQL.size() + 1, &loadTestersStmt, 0);
